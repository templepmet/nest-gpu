...
NonBlockingTimer *PackSendSpike_timer;
NonBlockingTimer *SendRecvSpikeRemote_immed_timer;
NonBlockingTimer *SendRecvSpikeRemote_delay_timer;
NonBlockingTimer *UnpackRecvSpike_timer;
...
double NonBlockingTimer::getTime() { return getTimeHost() + getTimeDevice(); }
