...
extern "C"
{
  ...
  int NESTGPU_AddDebugMode(char *debug_mode)
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
      ret = NESTGPU_instance->AddDebugMode(debug_mode);
    }
    END_ERR_PROP return ret;
  }
                           ...
                           int n_node)
  {
    ...
    BEGIN_ERR_PROP
    {
      ...
      ret = NESTGPU_instance->CreateRecord(file_name_str, var_name_vect.data(), i_node_arr, port_arr,
                                           n_node);
    }
    END_ERR_PROP return ret;
  }
                                  ...
                                  float *weight)
  {
    ...
    BEGIN_ERR_PROP
    {
      ...
      ConnectionStatus conn_stat = NESTGPU_instance->GetConnectionStatus(conn_id);
