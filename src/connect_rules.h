...
template <class T1, class T2>
int NESTGPU::_ConnectAllToAll(T1 source, int n_source, T2 target, int n_target, SynSpec &syn_spec)
{
#ifdef _OPENMP
...
template <class T1, class T2>
int NESTGPU::_ConnectFixedTotalNumber(T1 source, int n_source, T2 target, int n_target, int n_conn,
                                      SynSpec &syn_spec)
{
...
template <class T1, class T2>
int NESTGPU::_RemoteConnectOneToOne(RemoteNode<T1> source, RemoteNode<T2> target, int n_node,
                                    SynSpec &syn_spec)
{
...
template <class T1, class T2>
int NESTGPU::_RemoteConnectAllToAll(RemoteNode<T1> source, int n_source, RemoteNode<T2> target, int n_target,
                                    SynSpec &syn_spec)
{
  if (MpiId() == source.i_host_ && source.i_host_ == target.i_host_)
  {
...
template <class T1, class T2>
int NESTGPU::_RemoteConnectFixedTotalNumber(RemoteNode<T1> source, int n_source, RemoteNode<T2> target, int n_target,
...
template <class T1, class T2>
int NESTGPU::_RemoteConnectFixedIndegree(RemoteNode<T1> source, int n_source, RemoteNode<T2> target, int n_target,
...
template <class T1, class T2>
int NESTGPU::_RemoteConnectFixedOutdegree(RemoteNode<T1> source, int n_source, RemoteNode<T2> target, int n_target,
