...
time \
	mpirun $NQSV_MPIOPTS -np 32 -npernode 2 --map-by core --bind-to core --display-devel-map \
	./wrap_cuda.sh 2 singularity exec --nv --bind $SINGULARITY_PWD $SINGULARITY_IMAGE \
